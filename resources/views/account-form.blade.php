    ...
    <div class="px-4 py-5 bg-white sm:p-6 text-gray-900">
       <div class="grid grid-cols-6 gap-6">
        ...
        <div class="col-span-8 md:col-span-4">
             <label class="block font-medium text-sm" for="name">Name of the account <span style="color:#F1541E;">*</span></label>
             <input class="form-input rounded-md shadow-sm mt-1 block w-full" id="name" name="name" type="text" value="{{ $account->name }}" required>
        </div>
