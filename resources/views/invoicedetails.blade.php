    ...
    <div class="py-12">
		...
		@foreach (['danger', 'warning', 'success', 'info'] as $msg)
			...
			<div class="text-right">
				...
				<form name="save-entity" action="/admin/saveinvoice" method="post">
    ...
    <div class="px-4 py-5 bg-white sm:p-6 text-gray-900">
       <div class="grid grid-cols-6 gap-6">
        ...
        <div class="col-span-8">
             ...
             <textarea class="form-input rounded-md shadow-sm mt-1 block w-full" id="description" name="description" type="text" readonly style="background:#eee;">{{ $invoice->description }}</textarea readonly style="background:#eee;">
        </div>
