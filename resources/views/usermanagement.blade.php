    ...
    <div class="py-12">
		...
		<div class="text-right">
			...
			<thead class="text-primary">
                        ...
                        <!--td>{{ \Illuminate\Support\Str::limit($u->notes_on_this_person, 50, $end='...') }}</td-->
			<td>
				<a href="/admin/user/{{ $u->id }}" title="View Details"><span class="fas fa-eye" style="padding:5%;"></span></a>
				@if(Auth::user()->hasRole('admin'))
				<a href="/admin/user-form/{{ $u->id }}" title="Edit"><span class="fas fa-pencil-alt" style="padding:5%;"></span></a>
				<!--button id="opener" onClick="showDeleteDialog({{ $u->id }});" title="Delete"><span class="fas fa-trash-alt"></span></button-->
                <!--input type="hidden" name="user_id" value="{{ $u->id }}" id="user_id"-->
                <button id="opener" class="delete_user" data-user-id="{{ $u->id }}" title="Delete"><span class="fas fa-trash-alt"></span></button>
				@endif
