...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form name="purchases_export" action="/admin/purchases" method="GET" id="downloadInvoices">
    ...
    <br />
        <div class="col-span-4 md:col-span-2">
            ...
            @if(!empty($_GET) && !empty($_GET['start_date']) && !empty($_GET['end_date']))
                <a class="m-5" title="Export Invoices" href="/admin/export/purhases_by_date?start_date={{ $_GET['start_date'] }}&end_date={{  $_GET['end_date'] }}">Export Invoices: <span class="fas fa-file-export"></span></a>
            @endif

            <div id="clear">&nbsp;</div>
			<div class="table-responsive">
                    <table id="purhases" class="display">
			...
			<td>
				...
				@if(Auth::user()->hasRole('admin'))
				<a href="/admin/invoice-form/{{ $c->id }}" title="Edit"><span class="fas fa-pencil-alt" style="padding:5%;"></span></a>
				<button id="opener" class="delete_invoice" data-invoice-id="{{ $c->id }}" title="Delete"><span class="fas fa-trash-alt"></span></button>
				@endif

	    <div id="deletedialog" style="display:none;" class="bg-grey">
                <form name="deleteinvoice" method="post" action="/admin/invoice/delete">
                @csrf
                <input type="hidden" id="delete_invoice_id" name="invoice_id" value="{{ $c->id }}" />
